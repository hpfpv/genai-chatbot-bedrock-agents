...
import uuid
import agents.bedrock as bedrock

USER_ICON = "images/user-icon.png"
AI_ICON = "images/bedrock-icon.png"
...
def write_top_bar():
    ...
    with col2:
        header = "Votre chatbot d'infrastructure intelligent"
...
st.markdown("---")
input = st.text_input(
    "Vous discutez avec une IA Generative. Posez une question.", key="input", on_change=handle_input
)